 ...
 *
 */
public class HiviewEdgeFilterServiceApp 
{
	

	 static final String APPLICATION_PATH = "/filter";
	 static final String CONTEXT_ROOT = "/";
	  
	  public HiviewEdgeFilterServiceApp() {}
	  ...
	  {
		System.out.println("You can use -Dndex.edgeFilterPort=8294 and -Dndex.fileRepoPrefix=/opt/ndex/data/ to set runtime parameters.");
		...
		String portStr = System.getProperty("ndex.edgeFilterPort", "8294")  ;
		String serverFileRepoPrefix = System.getProperty("ndex.fileRepoPrefix", "/opt/ndex/data/");
	    final int port = Integer.valueOf(portStr);
	    NetworkEdgeFilterQueryManager.setDataFilePathPrefix(serverFileRepoPrefix);
	    ...
	    restEasyServlet.setInitParameter("javax.ws.rs.Application",
	      "org.ndexbio.service.edgefilter.hiview.EdgeFilterQueryApplication");
